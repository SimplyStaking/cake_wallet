...
void main() {
  testWidgets('provider toggles persist and decentralized-only preserves the blocked preference',
      (tester) async {
    ...
    await tester.pumpAndSettle();
    expect(find.byType(ListItemToggleWidget), findsNWidgets(3));
    expect(find.text(S.current.decentralized_only), findsOneWidget);
